...
namespace Coherence.Generated
{
    ...
    public struct _21cb728274153f54c8abde62f5c205eb_8313270696784286322 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _21cb728274153f54c8abde62f5c205eb_8313270696784286322.rotationMask;
            rotationSimulationFrame = frame;
        }

        public static unsafe _21cb728274153f54c8abde62f5c205eb_8313270696784286322 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 16) {
            ...
            var orig = new _21cb728274153f54c8abde62f5c205eb_8313270696784286322();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & _21cb728274153f54c8abde62f5c205eb_8313270696784286322.rotationMask) != 0 && (min == null || this.rotationSimulationFrame < min))
            {
        ...
        {
            var other = (_21cb728274153f54c8abde62f5c205eb_8313270696784286322)data;
        ...
        public static uint Serialize(_21cb728274153f54c8abde62f5c205eb_8313270696784286322 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _21cb728274153f54c8abde62f5c205eb_8313270696784286322 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _21cb728274153f54c8abde62f5c205eb_8313270696784286322();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= _21cb728274153f54c8abde62f5c205eb_8313270696784286322.rotationMask;
            }
        ...
        {
            return $"_21cb728274153f54c8abde62f5c205eb_8313270696784286322(" +

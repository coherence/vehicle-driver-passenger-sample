...
namespace Coherence.Generated
{
    ...
    public struct _a6f62748104f3194aace021743ab9cc0_1680387227265687212 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _a6f62748104f3194aace021743ab9cc0_1680387227265687212.pathMask;
            pathSimulationFrame = frame;
            FieldsMask |= _a6f62748104f3194aace021743ab9cc0_1680387227265687212.pathDirtyCounterMask;
            pathDirtyCounterSimulationFrame = frame;
        }

        public static unsafe _a6f62748104f3194aace021743ab9cc0_1680387227265687212 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 20) {
            ...
            var orig = new _a6f62748104f3194aace021743ab9cc0_1680387227265687212();
        ...
        {
            var other = (_a6f62748104f3194aace021743ab9cc0_1680387227265687212)data;
        ...
        public static uint Serialize(_a6f62748104f3194aace021743ab9cc0_1680387227265687212 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                Coherence.Utils.Bounds.Check(data.pathDirtyCounter, _pathDirtyCounter_Min, _pathDirtyCounter_Max, "_a6f62748104f3194aace021743ab9cc0_1680387227265687212.pathDirtyCounter", logger);
        ...
        public static _a6f62748104f3194aace021743ab9cc0_1680387227265687212 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _a6f62748104f3194aace021743ab9cc0_1680387227265687212();
            if (bitStream.ReadMask())
            {

                val.path = bitStream.ReadShortString();
                val.FieldsMask |= _a6f62748104f3194aace021743ab9cc0_1680387227265687212.pathMask;
            }
            if (bitStream.ReadMask())
            {

                val.pathDirtyCounter = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _a6f62748104f3194aace021743ab9cc0_1680387227265687212.pathDirtyCounterMask;
            }
        ...
        {
            return $"_a6f62748104f3194aace021743ab9cc0_1680387227265687212(" +
                $" path: { this.path }" +

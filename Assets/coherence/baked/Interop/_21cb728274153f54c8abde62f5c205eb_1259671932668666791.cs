...
namespace Coherence.Generated
{
    ...
    public struct _21cb728274153f54c8abde62f5c205eb_1259671932668666791 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _21cb728274153f54c8abde62f5c205eb_1259671932668666791.rotationMask;
            rotationSimulationFrame = frame;
        }

        public static unsafe _21cb728274153f54c8abde62f5c205eb_1259671932668666791 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 16) {
            ...
            var orig = new _21cb728274153f54c8abde62f5c205eb_1259671932668666791();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & _21cb728274153f54c8abde62f5c205eb_1259671932668666791.rotationMask) != 0 && (min == null || this.rotationSimulationFrame < min))
            {
        ...
        {
            var other = (_21cb728274153f54c8abde62f5c205eb_1259671932668666791)data;
        ...
        public static uint Serialize(_21cb728274153f54c8abde62f5c205eb_1259671932668666791 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _21cb728274153f54c8abde62f5c205eb_1259671932668666791 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _21cb728274153f54c8abde62f5c205eb_1259671932668666791();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= _21cb728274153f54c8abde62f5c205eb_1259671932668666791.rotationMask;
            }
        ...
        {
            return $"_21cb728274153f54c8abde62f5c205eb_1259671932668666791(" +

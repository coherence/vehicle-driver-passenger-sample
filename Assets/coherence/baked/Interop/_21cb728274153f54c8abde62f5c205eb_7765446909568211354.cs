...
namespace Coherence.Generated
{
    ...
    public struct _21cb728274153f54c8abde62f5c205eb_7765446909568211354 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _21cb728274153f54c8abde62f5c205eb_7765446909568211354.positionMask;
            positionSimulationFrame = frame;
        }

        public static unsafe _21cb728274153f54c8abde62f5c205eb_7765446909568211354 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 12) {
            ...
            var orig = new _21cb728274153f54c8abde62f5c205eb_7765446909568211354();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & _21cb728274153f54c8abde62f5c205eb_7765446909568211354.positionMask) != 0 && (min == null || this.positionSimulationFrame < min))
            {
        ...
        {
            var other = (_21cb728274153f54c8abde62f5c205eb_7765446909568211354)data;
        ...
        public static uint Serialize(_21cb728274153f54c8abde62f5c205eb_7765446909568211354 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _21cb728274153f54c8abde62f5c205eb_7765446909568211354 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _21cb728274153f54c8abde62f5c205eb_7765446909568211354();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= _21cb728274153f54c8abde62f5c205eb_7765446909568211354.positionMask;
            }
        ...
        {
            return $"_21cb728274153f54c8abde62f5c205eb_7765446909568211354(" +
